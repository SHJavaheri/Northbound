...
export const Principles = () => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_top,_rgba(124,58,237,0.15),_rgba(10,10,10,0))] mix-blend-screen opacity-80" />
